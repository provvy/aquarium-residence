...
const CookieScreen = ({ history }) => {
  ...
  return (
    <CookieScreenWrapper>
      <Helmet>
        <title>Aquarium Residence | Cookie Policy</title>
        <meta
          name="description"
          content="La nostra politica riguardo l'utilizzo dei cookies tecnici e analitici."
        />
        <link
          rel="canonical"
          href="https://www.aquariumresidence.com/cookie-policy"
        />
        <meta property="og:locale" content="it_IT" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Aquarium Residence | Cookie Policy"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.aquariumresidence.com/cookie-policy"
        />
      ...
      <TitleContainer>
        <Div>
          <H2 scrolled={scrolled}>I Cookies</H2>
        </Div>
      </TitleContainer>
      <Main>
        <CookieSection />
...
const CookieScreenWrapper = styled.div`
  width: 100%;
  max-width: 100%;
  height: 100%;
`;
